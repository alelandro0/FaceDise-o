    ...
    <div className="relative bg-white/20 p-2 rounded-lg w-[70%] sm:w-[60%] max-w-[800px] modalCard max-h-[80vh] flex flex-col overflow-y-auto lg:text-lg lg:w-[90%]">
      ...
      <div className="w-full text-white p-8 flex flex-col bg-black/80 border-opacity-70 border-primary-color rounded-bl-lg rounded-br-lg">
        ...
        <ul>
          ...
          <li>
            <span className="text-primary-color">Ver: </span>
            <a
              target="_blank"
              className="hover:underline hover:underline-offset-4 hover:text-dark-green transition-all duration-500 text-white"
              href={SelectedProject.demo} rel="noreferrer"
            >
              A un Click de nuestros Servicios.
            </a>
          </li>

          <li>
            <span className="text-primary-color">Codigo: </span>
            <a
              target="_blank"
              className="hover:underline hover:underline-offset-4 hover:text-dark-white transition-all duration-500 text-black"
              href={SelectedProject.code} rel="noreferrer"
            >
